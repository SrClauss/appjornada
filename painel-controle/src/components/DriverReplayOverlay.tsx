...
export function DriverReplayOverlay({
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-[500] p-4 pointer-events-none flex flex-col items-center gap-3">
      {/* Top Banner: Current Telemetry Snapshot */}
      <div className="pointer-events-auto bg-[#0d1117]/95 backdrop-blur-xl border border-sky-500/30 rounded-2xl p-3.5 shadow-2xl shadow-sky-950/40 w-full max-w-3xl flex flex-wrap items-center justify-between gap-3 text-xs">
        ...
        {/* Metrics Badge Group */}
        <div className="flex items-center gap-3 text-slate-300 font-mono text-[11px] bg-slate-900/80 px-3 py-1.5 rounded-xl border border-slate-800 shrink-0">
        ...
        <button
          onClick={onClose}
          className="p-1.5 rounded-xl bg-slate-800 hover:bg-rose-500/20 text-slate-400 hover:text-rose-300 border border-slate-700 transition-all shrink-0"
          title="Fechar Replay"
        >
          <X size={16} />
        </button>
      ...
      {/* Main Controls Card */}
      <div className="pointer-events-auto bg-[#0d1117]/95 backdrop-blur-xl border border-slate-800 rounded-2xl p-4 shadow-2xl w-full max-w-3xl flex flex-col gap-3">
        {/* Timeline Slider */}
        <div className="flex items-center gap-3">
          <span className="text-xs font-mono font-semibold text-slate-400 min-w-[55px]">
          ...
          <span className="text-xs font-mono text-slate-500 min-w-[55px] text-right">
            {endTimeStr}
          </span>
        </div>
