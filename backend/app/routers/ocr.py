...
def _chamar_gemini_extrato_video(frames_b64_list: list, frame_urls: list = None, plataforma_esperada: str = None, faturamento_ancora: float = None, corridas_ancora: int = None) -> dict:
    ...
    prompt = (
        ...
        "  1. HORÁRIO e VALOR: Para ser considerada a mesma corrida (duplicada), ela DEVE ter OBRIGATORIAMENTE o mesmo HORÁRIO e o mesmo VALOR.\n"
        "  2. ALERTA CRÍTICO: Se duas corridas tiverem o mesmo horário (ex: 18:31), mas VALORES DIFERENTES (ex: 27.42 e 39.09), ELAS SÃO CORRIDAS DIFERENTES! Você NÃO DEVE desduplicar ou ignorar nenhuma delas.\n"
        "  3. ENDEREÇO: Por fim, se ainda houver dúvida (horário e valor idênticos), valide o endereço de origem e destino para ter certeza.\n"
